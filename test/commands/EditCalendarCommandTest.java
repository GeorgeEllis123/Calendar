...
public class EditCalendarCommandTest {
    ...
    public void testEditEventWithUse() {
        ...
        command.execute(new String[]{"edit", "event", "location", "meeting", "from", "2025-06-05T10:00", "to",
    ...
    public void testFutureSeriesWithUse() {
        ...
        command.execute(new String[]{"edit", "events", "subject", "meeting", "from", "2025-06-05T10:00", "with",
            "newMeeting"});
